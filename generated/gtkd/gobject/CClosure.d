...
public class CClosure
{
	 ...
	 */
	public this(GCallback callbackFunc, void* userData, GClosureNotify destroyData)
	{
		auto __p = g_cclosure_new(callbackFunc, userData, destroyData);
	...
	{
		auto __p = g_cclosure_new_object(callbackFunc, (object is null) ? null : object.getObjectGStruct());
	...
	{
		auto __p = g_cclosure_new_object_swap(callbackFunc, (object is null) ? null : object.getObjectGStruct());
	...
	{
		auto __p = g_cclosure_new_swap(callbackFunc, userData, destroyData);
