...
public class PixbufAnimation : ObjectG
{
	...
	public static PixbufAnimation newFromFile(string filename)
	{
		...
		return ObjectG.getDObject!(PixbufAnimation)(cast(GdkPixbufAnimation*) __p, true);
	}
	...
	public static PixbufAnimation newFromResource(string resourcePath)
	{
		...
		auto __p = gdk_pixbuf_animation_new_from_resource(Str.toStringz(resourcePath), &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static PixbufAnimation newFromStreamFinish(AsyncResultIF asyncResult)
	{
		GError* err = null;
