...
public class PixbufLoader : ObjectG
{
	...
	public static PixbufLoader newWithMimeType(string mimeType)
	{
		...
		auto __p = gdk_pixbuf_loader_new_with_mime_type(Str.toStringz(mimeType), &err);
		...
		return ObjectG.getDObject!(PixbufLoader)(cast(GdkPixbufLoader*) __p, true);
	}
	...
	public static PixbufLoader newWithType(string imageType)
	{
		...
		auto __p = gdk_pixbuf_loader_new_with_type(Str.toStringz(imageType), &err);
