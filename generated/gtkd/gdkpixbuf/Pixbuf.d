...
public class Pixbuf : ObjectG, IconIF, LoadableIconIF
{
	 ...
	 * Since: 2.32
	 */
	public static Pixbuf newFromBytes(Bytes data, GdkColorspace colorspace, bool hasAlpha, int bitsPerSample, int width, int height, int rowstride)
	{
	 ...
	 * Returns: A newly-created pixbuf
	 */
	public static Pixbuf newFromData(char[] data, GdkColorspace colorspace, bool hasAlpha, int bitsPerSample, int width, int height, int rowstride, GdkPixbufDestroyNotify destroyFn, void* destroyFnData)
	{
	 ...
	 * Throws: GException on failure.
	 */
	public static Pixbuf newFromInline(ubyte[] data, bool copyPixels)
	{
		GError* err = null;
	...
	public static Pixbuf newFromResource(string resourcePath)
	{
		...
		auto __p = gdk_pixbuf_new_from_resource(Str.toStringz(resourcePath), &err);
	...
	public static Pixbuf newFromResourceAtScale(string resourcePath, int width, int height, bool preserveAspectRatio)
	{
		...
		auto __p = gdk_pixbuf_new_from_resource_at_scale(Str.toStringz(resourcePath), width, height, preserveAspectRatio, &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static Pixbuf newFromStreamFinish(AsyncResultIF asyncResult)
	{
		GError* err = null;
