...
shared static this()
{
	...
	Linker.link(gdk_file_list_new_from_array, "gdk_file_list_new_from_array", LIBRARY_GDK);
	Linker.link(gdk_file_list_new_from_list, "gdk_file_list_new_from_list", LIBRARY_GDK);
	...
	Linker.link(gdk_monitor_get_description, "gdk_monitor_get_description", LIBRARY_GDK);
	...
	Linker.link(gdk_scroll_event_get_unit, "gdk_scroll_event_get_unit", LIBRARY_GDK);
	...
	Linker.link(gdk_texture_get_format, "gdk_texture_get_format", LIBRARY_GDK);
	...
	Linker.link(gdk_texture_downloader_get_type, "gdk_texture_downloader_get_type", LIBRARY_GDK);
	Linker.link(gdk_texture_downloader_new, "gdk_texture_downloader_new", LIBRARY_GDK);
	Linker.link(gdk_texture_downloader_copy, "gdk_texture_downloader_copy", LIBRARY_GDK);
	Linker.link(gdk_texture_downloader_download_bytes, "gdk_texture_downloader_download_bytes", LIBRARY_GDK);
	Linker.link(gdk_texture_downloader_download_into, "gdk_texture_downloader_download_into", LIBRARY_GDK);
	Linker.link(gdk_texture_downloader_free, "gdk_texture_downloader_free", LIBRARY_GDK);
	Linker.link(gdk_texture_downloader_get_format, "gdk_texture_downloader_get_format", LIBRARY_GDK);
	Linker.link(gdk_texture_downloader_get_texture, "gdk_texture_downloader_get_texture", LIBRARY_GDK);
	Linker.link(gdk_texture_downloader_set_format, "gdk_texture_downloader_set_format", LIBRARY_GDK);
	Linker.link(gdk_texture_downloader_set_texture, "gdk_texture_downloader_set_texture", LIBRARY_GDK);
...
__gshared extern(C)
{
	...
	GdkTextureDownloader* function(GdkTextureDownloader* self) c_gdk_texture_downloader_copy;
	GBytes* function(GdkTextureDownloader* self, size_t* outStride) c_gdk_texture_downloader_download_bytes;
	void function(GdkTextureDownloader* self, char* data, size_t stride) c_gdk_texture_downloader_download_into;
	void function(GdkTextureDownloader* self) c_gdk_texture_downloader_free;
	GdkMemoryFormat function(GdkTextureDownloader* self) c_gdk_texture_downloader_get_format;
	GdkTexture* function(GdkTextureDownloader* self) c_gdk_texture_downloader_get_texture;
...
alias c_gdk_file_list_new_from_array gdk_file_list_new_from_array;
alias c_gdk_file_list_new_from_list gdk_file_list_new_from_list;
...
alias c_gdk_monitor_get_description gdk_monitor_get_description;
...
alias c_gdk_scroll_event_get_unit gdk_scroll_event_get_unit;
...
alias c_gdk_texture_get_format gdk_texture_get_format;
...
alias c_gdk_texture_downloader_get_type gdk_texture_downloader_get_type;
alias c_gdk_texture_downloader_new gdk_texture_downloader_new;
alias c_gdk_texture_downloader_copy gdk_texture_downloader_copy;
alias c_gdk_texture_downloader_download_bytes gdk_texture_downloader_download_bytes;
alias c_gdk_texture_downloader_download_into gdk_texture_downloader_download_into;
alias c_gdk_texture_downloader_free gdk_texture_downloader_free;
alias c_gdk_texture_downloader_get_format gdk_texture_downloader_get_format;
alias c_gdk_texture_downloader_get_texture gdk_texture_downloader_get_texture;
alias c_gdk_texture_downloader_set_format gdk_texture_downloader_set_format;
alias c_gdk_texture_downloader_set_texture gdk_texture_downloader_set_texture;
