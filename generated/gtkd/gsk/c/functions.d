...
shared static this()
{
	...
	Linker.link(gsk_mask_node_get_type, "gsk_mask_node_get_type", LIBRARY_GSK);
	Linker.link(gsk_mask_node_new, "gsk_mask_node_new", LIBRARY_GSK);
	Linker.link(gsk_mask_node_get_mask, "gsk_mask_node_get_mask", LIBRARY_GSK);
	Linker.link(gsk_mask_node_get_mask_mode, "gsk_mask_node_get_mask_mode", LIBRARY_GSK);
	Linker.link(gsk_mask_node_get_source, "gsk_mask_node_get_source", LIBRARY_GSK);
	...
	Linker.link(gsk_texture_scale_node_get_type, "gsk_texture_scale_node_get_type", LIBRARY_GSK);
	Linker.link(gsk_texture_scale_node_new, "gsk_texture_scale_node_new", LIBRARY_GSK);
	Linker.link(gsk_texture_scale_node_get_filter, "gsk_texture_scale_node_get_filter", LIBRARY_GSK);
	Linker.link(gsk_texture_scale_node_get_texture, "gsk_texture_scale_node_get_texture", LIBRARY_GSK);
...
__gshared extern(C)
{
	...
	GskRenderNode* function(GskRenderNode* node) c_gsk_mask_node_get_mask;
	GskMaskMode function(GskRenderNode* node) c_gsk_mask_node_get_mask_mode;
	GskRenderNode* function(GskRenderNode* node) c_gsk_mask_node_get_source;
	...
	GskRenderNode* function(GdkTexture* texture, graphene_rect_t* bounds, GskScalingFilter filter) c_gsk_texture_scale_node_new;
	GskScalingFilter function(GskRenderNode* node) c_gsk_texture_scale_node_get_filter;
	GdkTexture* function(GskRenderNode* node) c_gsk_texture_scale_node_get_texture;
...
alias c_gsk_mask_node_get_type gsk_mask_node_get_type;
alias c_gsk_mask_node_new gsk_mask_node_new;
alias c_gsk_mask_node_get_mask gsk_mask_node_get_mask;
alias c_gsk_mask_node_get_mask_mode gsk_mask_node_get_mask_mode;
alias c_gsk_mask_node_get_source gsk_mask_node_get_source;
...
alias c_gsk_texture_scale_node_get_type gsk_texture_scale_node_get_type;
alias c_gsk_texture_scale_node_new gsk_texture_scale_node_new;
alias c_gsk_texture_scale_node_get_filter gsk_texture_scale_node_get_filter;
alias c_gsk_texture_scale_node_get_texture gsk_texture_scale_node_get_texture;
