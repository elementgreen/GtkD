...
public class DBusMessage : ObjectG
{
	 ...
	 */
	public static DBusMessage newFromBlob(char[] blob, GDBusCapabilityFlags capabilities)
	{
		GError* err = null;
	 ...
	 * Since: 2.26
	 */
	public static DBusMessage newMethodCall(string name, string path, string interface_, string method)
	{
	 ...
	 * Since: 2.26
	 */
	public static DBusMessage newSignal(string path, string interface_, string signal)
	{
