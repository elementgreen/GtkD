...
public interface FileIF{
	 ...
	 */
	public static FileIF newForCommandlineArg(string arg)
	{
		auto __p = g_file_new_for_commandline_arg(Str.toStringz(arg));
	 ...
	 * Since: 2.36
	 */
	public static FileIF newForCommandlineArgAndCwd(string arg, string cwd)
	{
		auto __p = g_file_new_for_commandline_arg_and_cwd(Str.toStringz(arg), Str.toStringz(cwd));
	 ...
	 *     Free the returned object with g_object_unref().
	 */
	public static FileIF newForPath(string path)
	{
		auto __p = g_file_new_for_path(Str.toStringz(path));
	 ...
	 *     Free the returned object with g_object_unref().
	 */
	public static FileIF newForUri(string uri)
	{
		auto __p = g_file_new_for_uri(Str.toStringz(uri));
	 ...
	 */
	public static FileIF newTmp(string tmpl, out FileIOStream iostream)
	{
		GFileIOStream* outiostream = null;
		GError* err = null;

		auto __p = g_file_new_tmp(Str.toStringz(tmpl), &outiostream, &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static FileIF newTmpDirFinish(AsyncResultIF result)
	{
		GError* err = null;

		auto __p = g_file_new_tmp_dir_finish((result is null) ? null : result.getAsyncResultStruct(), &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static FileIF newTmpFinish(AsyncResultIF result, out FileIOStream iostream)
	{
		GFileIOStream* outiostream = null;
		GError* err = null;

		auto __p = g_file_new_tmp_finish((result is null) ? null : result.getAsyncResultStruct(), &outiostream, &err);
