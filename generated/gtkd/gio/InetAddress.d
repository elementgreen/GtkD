...
public class InetAddress : ObjectG
{
	 ...
	 * Since: 2.22
	 */
	public static InetAddress newAny(GSocketFamily family)
	{
		auto __p = g_inet_address_new_any(family);
		...
		return ObjectG.getDObject!(InetAddress)(cast(GInetAddress*) __p, true);
	}
	 ...
	 * Since: 2.22
	 */
	public static InetAddress newFromBytes(ubyte[] bytes, GSocketFamily family)
	{
	 ...
	 * Since: 2.22
	 */
	public static InetAddress newFromString(string string_)
	{
	 ...
	 * Since: 2.22
	 */
	public static InetAddress newLoopback(GSocketFamily family)
	{
		auto __p = g_inet_address_new_loopback(family);
