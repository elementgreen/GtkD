...
public class DBusProxy : ObjectG, AsyncInitableIF, DBusInterfaceIF, InitableIF
{
	 ...
	 */
	public static DBusProxy newFinish(AsyncResultIF res)
	{
		GError* err = null;

		auto __p = g_dbus_proxy_new_finish((res is null) ? null : res.getAsyncResultStruct(), &err);
		...
		return ObjectG.getDObject!(DBusProxy)(cast(GDBusProxy*) __p, true);
	}
	 ...
	 * Throws: GException on failure.
	 */
	public static DBusProxy newForBusFinish(AsyncResultIF res)
	{
		GError* err = null;

		auto __p = g_dbus_proxy_new_for_bus_finish((res is null) ? null : res.getAsyncResultStruct(), &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static DBusProxy newForBusSync(GBusType busType, GDBusProxyFlags flags, DBusInterfaceInfo info, string name, string objectPath, string interfaceName, Cancellable cancellable)
	{
		GError* err = null;
	 ...
	 * Throws: GException on failure.
	 */
	public static DBusProxy newSync(DBusConnection connection, GDBusProxyFlags flags, DBusInterfaceInfo info, string name, string objectPath, string interfaceName, Cancellable cancellable)
	{
		GError* err = null;
