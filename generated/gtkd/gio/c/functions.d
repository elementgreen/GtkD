...
shared static this()
{
	...
	Linker.link(g_app_info_get_default_for_type_async, "g_app_info_get_default_for_type_async", LIBRARY_GIO);
	Linker.link(g_app_info_get_default_for_type_finish, "g_app_info_get_default_for_type_finish", LIBRARY_GIO);
	Linker.link(g_app_info_get_default_for_uri_scheme, "g_app_info_get_default_for_uri_scheme", LIBRARY_GIO);
	Linker.link(g_app_info_get_default_for_uri_scheme_async, "g_app_info_get_default_for_uri_scheme_async", LIBRARY_GIO);
	Linker.link(g_app_info_get_default_for_uri_scheme_finish, "g_app_info_get_default_for_uri_scheme_finish", LIBRARY_GIO);
	...
	Linker.link(g_file_new_tmp_async, "g_file_new_tmp_async", LIBRARY_GIO);
	Linker.link(g_file_new_tmp_dir_async, "g_file_new_tmp_dir_async", LIBRARY_GIO);
	Linker.link(g_file_new_tmp_dir_finish, "g_file_new_tmp_dir_finish", LIBRARY_GIO);
	Linker.link(g_file_new_tmp_finish, "g_file_new_tmp_finish", LIBRARY_GIO);
	...
	Linker.link(g_file_make_symbolic_link_async, "g_file_make_symbolic_link_async", LIBRARY_GIO);
	Linker.link(g_file_make_symbolic_link_finish, "g_file_make_symbolic_link_finish", LIBRARY_GIO);
	...
	Linker.link(g_list_store_find_with_equal_func_full, "g_list_store_find_with_equal_func_full", LIBRARY_GIO);
	...
	Linker.link(g_task_set_static_name, "g_task_set_static_name", LIBRARY_GIO);
...
__gshared extern(C)
{
	...
	void function(const(char)* contentType, int mustSupportUris, GCancellable* cancellable, GAsyncReadyCallback callback, void* userData) c_g_app_info_get_default_for_type_async;
	GAppInfo* function(GAsyncResult* result, GError** err) c_g_app_info_get_default_for_type_finish;
	...
	GAppInfo* function(GAsyncResult* result, GError** err) c_g_app_info_get_default_for_uri_scheme_finish;
	...
	void function(char* tmpl, int ioPriority, GCancellable* cancellable, GAsyncReadyCallback callback, void* userData) c_g_file_new_tmp_async;
	void function(char* tmpl, int ioPriority, GCancellable* cancellable, GAsyncReadyCallback callback, void* userData) c_g_file_new_tmp_dir_async;
	GFile* function(GAsyncResult* result, GError** err) c_g_file_new_tmp_dir_finish;
	GFile* function(GAsyncResult* result, GFileIOStream** iostream, GError** err) c_g_file_new_tmp_finish;
	...
	void function(GFile* file, char* symlinkValue, int ioPriority, GCancellable* cancellable, GAsyncReadyCallback callback, void* userData) c_g_file_make_symbolic_link_async;
	int function(GFile* file, GAsyncResult* result, GError** err) c_g_file_make_symbolic_link_finish;
	...
	int function(GListStore* store, void* item, GEqualFuncFull equalFunc, void* userData, uint* position) c_g_list_store_find_with_equal_func_full;
...
alias c_g_app_info_get_default_for_type_async g_app_info_get_default_for_type_async;
alias c_g_app_info_get_default_for_type_finish g_app_info_get_default_for_type_finish;
alias c_g_app_info_get_default_for_uri_scheme g_app_info_get_default_for_uri_scheme;
alias c_g_app_info_get_default_for_uri_scheme_async g_app_info_get_default_for_uri_scheme_async;
alias c_g_app_info_get_default_for_uri_scheme_finish g_app_info_get_default_for_uri_scheme_finish;
...
alias c_g_file_new_tmp_async g_file_new_tmp_async;
alias c_g_file_new_tmp_dir_async g_file_new_tmp_dir_async;
alias c_g_file_new_tmp_dir_finish g_file_new_tmp_dir_finish;
alias c_g_file_new_tmp_finish g_file_new_tmp_finish;
...
alias c_g_file_make_symbolic_link_async g_file_make_symbolic_link_async;
alias c_g_file_make_symbolic_link_finish g_file_make_symbolic_link_finish;
...
alias c_g_list_store_find_with_equal_func_full g_list_store_find_with_equal_func_full;
...
alias c_g_task_set_static_name g_task_set_static_name;
