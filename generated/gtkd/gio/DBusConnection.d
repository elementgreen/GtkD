...
public class DBusConnection : ObjectG, AsyncInitableIF, InitableIF
{
	 ...
	 */
	public static DBusConnection newFinish(AsyncResultIF res)
	{
		GError* err = null;

		auto __p = g_dbus_connection_new_finish((res is null) ? null : res.getAsyncResultStruct(), &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static DBusConnection newForAddressFinish(AsyncResultIF res)
	{
		GError* err = null;

		auto __p = g_dbus_connection_new_for_address_finish((res is null) ? null : res.getAsyncResultStruct(), &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static DBusConnection newForAddressSync(string address, GDBusConnectionFlags flags, DBusAuthObserver observer, Cancellable cancellable)
	{
		GError* err = null;
	 ...
	 * Throws: GException on failure.
	 */
	public static DBusConnection newSync(IOStream stream, string guid, GDBusConnectionFlags flags, DBusAuthObserver observer, Cancellable cancellable)
	{
		GError* err = null;
