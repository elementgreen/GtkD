...
public class DBusObjectManagerClient : ObjectG, AsyncInitableIF, DBusObjectManagerIF, InitableIF
{
	 ...
	 */
	public static DBusObjectManagerClient newFinish(AsyncResultIF res)
	{
		GError* err = null;

		auto __p = g_dbus_object_manager_client_new_finish((res is null) ? null : res.getAsyncResultStruct(), &err);
		...
		return ObjectG.getDObject!(DBusObjectManagerClient)(cast(GDBusObjectManagerClient*) __p, true);
	}
	 ...
	 * Throws: GException on failure.
	 */
	public static DBusObjectManagerClient newForBusFinish(AsyncResultIF res)
	{
		GError* err = null;

		auto __p = g_dbus_object_manager_client_new_for_bus_finish((res is null) ? null : res.getAsyncResultStruct(), &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static DBusObjectManagerClient newForBusSync(GBusType busType, GDBusObjectManagerClientFlags flags, string name, string objectPath, GDBusProxyTypeFunc getProxyTypeFunc, void* getProxyTypeUserData, GDestroyNotify getProxyTypeDestroyNotify, Cancellable cancellable)
	{
		GError* err = null;
	 ...
	 * Throws: GException on failure.
	 */
	public static DBusObjectManagerClient newSync(DBusConnection connection, GDBusObjectManagerClientFlags flags, string name, string objectPath, GDBusProxyTypeFunc getProxyTypeFunc, void* getProxyTypeUserData, GDestroyNotify getProxyTypeDestroyNotify, Cancellable cancellable)
	{
		GError* err = null;
