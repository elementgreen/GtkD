...
public class Box
{
	...
	public static Box alloc()
	{
		...
		return ObjectG.getDObject!(Box)(cast(graphene_box_t*) __p, true);
	}
	...
	{
		graphene_sphere_t* outsphere = cast(graphene_sphere_t*)Memory.malloc0(graphene_sphere_t.sizeof);
	...
	{
		graphene_point3d_t* outcenter = cast(graphene_point3d_t*)Memory.malloc0(graphene_point3d_t.sizeof);
	...
	{
		graphene_point3d_t* outmax = cast(graphene_point3d_t*)Memory.malloc0(graphene_point3d_t.sizeof);
	...
	{
		graphene_point3d_t* outmin = cast(graphene_point3d_t*)Memory.malloc0(graphene_point3d_t.sizeof);
	...
	{
		graphene_vec3_t* outsize = cast(graphene_vec3_t*)Memory.malloc0(graphene_vec3_t.sizeof);
	...
	{
		graphene_vec3_t* outvertices = cast(graphene_vec3_t*)Memory.malloc0(graphene_vec3_t.sizeof * 8);
