...
public class Ray
{
	...
	public static Ray alloc()
	{
		...
		return ObjectG.getDObject!(Ray)(cast(graphene_ray_t*) __p, true);
	}
	...
	{
		graphene_vec3_t* outdirection = cast(graphene_vec3_t*)Memory.malloc0(graphene_vec3_t.sizeof);
	...
	{
		graphene_point3d_t* outorigin = cast(graphene_point3d_t*)Memory.malloc0(graphene_point3d_t.sizeof);
	...
	{
		graphene_point3d_t* outposition = cast(graphene_point3d_t*)Memory.malloc0(graphene_point3d_t.sizeof);
