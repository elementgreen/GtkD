...
public class Matrix
{
	...
	public static Matrix alloc()
	{
		...
		return ObjectG.getDObject!(Matrix)(cast(graphene_matrix_t*) __p, true);
	}
	...
	{
		graphene_vec3_t* outtranslate = cast(graphene_vec3_t*)Memory.malloc0(graphene_vec3_t.sizeof);
		graphene_vec3_t* outscale = cast(graphene_vec3_t*)Memory.malloc0(graphene_vec3_t.sizeof);
		graphene_quaternion_t* outrotate = cast(graphene_quaternion_t*)Memory.malloc0(graphene_quaternion_t.sizeof);
		graphene_vec3_t* outshear = cast(graphene_vec3_t*)Memory.malloc0(graphene_vec3_t.sizeof);
		graphene_vec4_t* outperspective = cast(graphene_vec4_t*)Memory.malloc0(graphene_vec4_t.sizeof);
	...
	{
		graphene_vec4_t* outres = cast(graphene_vec4_t*)Memory.malloc0(graphene_vec4_t.sizeof);
	...
	{
		graphene_matrix_t* outres = cast(graphene_matrix_t*)Memory.malloc0(graphene_matrix_t.sizeof);
	...
	{
		graphene_point_t* outres = cast(graphene_point_t*)Memory.malloc0(graphene_point_t.sizeof);
	...
	{
		graphene_quad_t* outres = cast(graphene_quad_t*)Memory.malloc0(graphene_quad_t.sizeof);
	...
	{
		graphene_rect_t* outres = cast(graphene_rect_t*)Memory.malloc0(graphene_rect_t.sizeof);
	...
	{
		graphene_box_t* outres = cast(graphene_box_t*)Memory.malloc0(graphene_box_t.sizeof);
	...
	{
		graphene_point3d_t* outres = cast(graphene_point3d_t*)Memory.malloc0(graphene_point3d_t.sizeof);
	...
	{
		graphene_ray_t* outres = cast(graphene_ray_t*)Memory.malloc0(graphene_ray_t.sizeof);
	...
	{
		graphene_sphere_t* outres = cast(graphene_sphere_t*)Memory.malloc0(graphene_sphere_t.sizeof);
	...
	{
		graphene_vec3_t* outres = cast(graphene_vec3_t*)Memory.malloc0(graphene_vec3_t.sizeof);
