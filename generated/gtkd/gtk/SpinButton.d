...
private import gtk.AccessibleRangeIF;
private import gtk.AccessibleRangeT;
 ...
 */
public class SpinButton : Widget, AccessibleRangeIF, CellEditableIF, EditableIF, OrientableIF
{
	/** the main Gtk struct */
	...
	// add the AccessibleRange capabilities
	...
	public static SpinButton newWithRange(double min, double max, double step)
	{
		...
		return ObjectG.getDObject!(SpinButton)(cast(GtkSpinButton*) __p);
	}
