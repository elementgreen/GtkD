...
public class Snapshot : DGdkSnapshot
{
	 ...
	 * Since: 4.10
	 */
	public void appendScaledTexture(Texture texture, GskScalingFilter filter, Rect bounds)
	{
		gtk_snapshot_append_scaled_texture(gtkSnapshot, (texture is null) ? null : texture.getTextureStruct(), filter, (bounds is null) ? null : bounds.getRectStruct());
	}
	 ...
	 * Since: 4.10
	 */
	public void pushMask(GskMaskMode maskMode)
	{
		gtk_snapshot_push_mask(gtkSnapshot, maskMode);
	}
