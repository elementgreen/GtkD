...
public class ComboBox : Widget, CellEditableIF, CellLayoutIF
{
	...
	public static ComboBox newWithEntry()
	{
		...
		return ObjectG.getDObject!(ComboBox)(cast(GtkComboBox*) __p);
	}
	 ...
	 * Returns: A new `GtkComboBox`
	 */
	public static ComboBox newWithModel(TreeModelIF model)
	{
	 ...
	 * Returns: A new `GtkComboBox`
	 */
	public static ComboBox newWithModelAndEntry(TreeModelIF model)
	{
