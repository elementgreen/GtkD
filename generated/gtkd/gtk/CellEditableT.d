...
public template CellEditableT(TStruct)
{
	...
	{
		return Signals.connect(this, "editing-done", dlg, connectFlags ^ ConnectFlags.SWAPPED);
	}
	...
	{
		return Signals.connect(this, "remove-widget", dlg, connectFlags ^ ConnectFlags.SWAPPED);
	}
}
