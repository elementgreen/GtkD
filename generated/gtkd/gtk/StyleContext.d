 ...
 * 
 * Deprecated: The relevant API has been moved to [class@Gtk.Widget]
...
public class StyleContext : ObjectG
{
	...
	{
		GtkBorder* outborder = cast(GtkBorder*)Memory.malloc0(GtkBorder.sizeof);
	...
	{
		GtkBorder* outmargin = cast(GtkBorder*)Memory.malloc0(GtkBorder.sizeof);
	...
	{
		GtkBorder* outpadding = cast(GtkBorder*)Memory.malloc0(GtkBorder.sizeof);
