...
public interface TreeDragSourceIF{
	 ...
	 *     is otherwise valid
	 */
	public static bool getRowDragData(Value value, out TreeModelIF treeModel, out TreePath path)
	{
		GtkTreeModel* outtreeModel = null;
		GtkTreePath* outpath = null;

		auto __p = gtk_tree_get_row_drag_data((value is null) ? null : value.getValueStruct(), &outtreeModel, &outpath) != 0;
