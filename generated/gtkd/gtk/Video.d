...
public class Video : Widget
{
	 ...
	 * Returns: a new `GtkVideo`
	 */
	public static Video newForFile(FileIF file)
	{
		...
		return ObjectG.getDObject!(Video)(cast(GtkVideo*) __p);
	}
	 ...
	 * Returns: a new `GtkVideo`
	 */
	public static Video newForFilename(string filename)
	{
	 ...
	 * Returns: a new `GtkVideo`
	 */
	public static Video newForResource(string resourcePath)
	{
