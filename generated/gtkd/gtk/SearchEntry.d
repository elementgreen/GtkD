...
public class SearchEntry : Widget, EditableIF
{
	...
	{
		return Str.toString(gtk_search_entry_get_placeholder_text(gtkSearchEntry));
	}
	...
	{
		return gtk_search_entry_get_search_delay(gtkSearchEntry);
	}
	...
	{
		gtk_search_entry_set_placeholder_text(gtkSearchEntry, Str.toStringz(text));
	}
	...
	{
		gtk_search_entry_set_search_delay(gtkSearchEntry, delay);
	}
