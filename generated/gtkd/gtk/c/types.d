...
alias GtkAccessiblePlatformState AccessiblePlatformState;
...
alias GtkContentFit ContentFit;
...
alias GtkDialogError DialogError;
...
alias GtkInscriptionOverflow InscriptionOverflow;
...
struct GtkAccessibleInterface
{
	 ...
	 */
	extern(C) int function(GtkAccessible* self, GtkAccessiblePlatformState state) getPlatformState;
	/**
	 *
	 * Params:
	 *     self = a `GtkAccessible`
	 ...
	 */
	extern(C) int function(GtkAccessible* self, int* x, int* y, int* width, int* height) getBounds;
}
...
struct GtkAccessibleRangeInterface
{
	 ...
	 */
	extern(C) int function(GtkAccessibleRange* self, double value) setCurrentValue;
}
