...
public class Picture : Widget
{
	 ...
	 */
	public static Picture newForFile(FileIF file)
	{
		...
		return ObjectG.getDObject!(Picture)(cast(GtkPicture*) __p);
	}
	 ...
	 * Returns: a new `GtkPicture`
	 */
	public static Picture newForPaintable(PaintableIF paintable)
	{
	 ...
	 * Since: 4.8
	 */
	public GtkContentFit getContentFit()
	{
		return gtk_picture_get_content_fit(gtkPicture);
	}
	 ...
	 *
	 * Deprecated: Use [method@Gtk.Picture.get_content_fit] instead. This will
	 ...
	 * Since: 4.8
	 */
	public void setContentFit(GtkContentFit contentFit)
	{
		gtk_picture_set_content_fit(gtkPicture, contentFit);
	}
	 ...
	 *
	 * Deprecated: Use [method@Gtk.Picture.set_content_fit] instead. If still
