...
public class SignalListItemFactory : ListItemFactory
{
	 ...
	 */
	gulong addOnBind(void delegate(ObjectG, SignalListItemFactory) dlg, ConnectFlags connectFlags=cast(ConnectFlags)0)
	{
	 ...
	 */
	gulong addOnSetup(void delegate(ObjectG, SignalListItemFactory) dlg, ConnectFlags connectFlags=cast(ConnectFlags)0)
	{
	 ...
	 */
	gulong addOnTeardown(void delegate(ObjectG, SignalListItemFactory) dlg, ConnectFlags connectFlags=cast(ConnectFlags)0)
	{
	 ...
	 */
	gulong addOnUnbind(void delegate(ObjectG, SignalListItemFactory) dlg, ConnectFlags connectFlags=cast(ConnectFlags)0)
	{
