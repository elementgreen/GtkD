...
public class TreeModelSort : ObjectG, TreeDragSourceIF, TreeModelIF, TreeSortableIF
{
	 ...
	 */
	public static TreeModelSort newWithModel(TreeModelIF childModel)
	{
		...
		return ObjectG.getDObject!(TreeModelSort)(cast(GtkTreeModelSort*) __p, true);
	}
	...
	{
		GtkTreeIter* outsortIter = cast(GtkTreeIter*)Memory.malloc0(GtkTreeIter.sizeof);
	...
	{
		GtkTreeIter* outchildIter = cast(GtkTreeIter*)Memory.malloc0(GtkTreeIter.sizeof);
