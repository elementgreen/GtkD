...
public class CheckButton : Widget, ActionableIF
{
	...
	public static CheckButton newWithLabel(string label)
	{
		...
		return ObjectG.getDObject!(CheckButton)(cast(GtkCheckButton*) __p);
	}
	...
	{
		auto __p = gtk_check_button_get_child(gtkCheckButton);
	...
	{
		gtk_check_button_set_child(gtkCheckButton, (child is null) ? null : child.getWidgetStruct());
	}
