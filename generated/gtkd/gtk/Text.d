...
public class Text : Widget, EditableIF
{
	...
	public static Text newWithBuffer(EntryBuffer buffer)
	{
		...
		return ObjectG.getDObject!(Text)(cast(GtkText*) __p);
	}
	...
	{
		graphene_rect_t* outstrong = cast(graphene_rect_t*)Memory.malloc0(graphene_rect_t.sizeof);
		graphene_rect_t* outweak = cast(graphene_rect_t*)Memory.malloc0(graphene_rect_t.sizeof);
