...
public class DateTime
{
	...
	{
		auto __p = g_date_time_new_from_timeval_local((tv is null) ? null : tv.getTimeValStruct());
	...
	{
		auto __p = g_date_time_new_from_timeval_utc((tv is null) ? null : tv.getTimeValStruct());
	...
	{
		auto __p = g_date_time_new_from_unix_local(t);
	...
	{
		auto __p = g_date_time_new_from_unix_utc(t);
	...
	{
		auto __p = g_date_time_new_local(year, month, day, hour, minute, seconds);
	...
	{
		auto __p = g_date_time_new_now_local();
	...
	{
		auto __p = g_date_time_new_now_utc();
	...
	{
		auto __p = g_date_time_new_utc(year, month, day, hour, minute, seconds);
