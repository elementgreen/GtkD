...
public class Variant
{
	 ...
	 * Since: 2.24
	 */
	public static Variant newByte(ubyte value)
	{
	 ...
	 * Since: 2.26
	 */
	public static Variant newBytestring(string string_)
	{
		auto __p = g_variant_new_bytestring(Str.toStringz(string_));
	 ...
	 * Since: 2.26
	 */
	public static Variant newBytestringArray(string[] strv)
	{
		auto __p = g_variant_new_bytestring_array(Str.toStringzArray(strv), cast(ptrdiff_t)strv.length);
	 ...
	 * Since: 2.32
	 */
	public static Variant newFixedArray(VariantType elementType, void* elements, size_t nElements, size_t elementSize)
	{
	 ...
	 * Since: 2.24
	 */
	public static Variant newFromData(VariantType type, ubyte[] data, bool trusted, GDestroyNotify notify, void* userData)
	{
	...
	{
		auto __p = g_variant_new_handle(value);
	...
	{
		auto __p = g_variant_new_object_path(Str.toStringz(objectPath));
	 ...
	 * Since: 2.30
	 */
	public static Variant newObjv(string[] strv)
	{
		auto __p = g_variant_new_objv(Str.toStringzArray(strv), cast(ptrdiff_t)strv.length);
	 ...
	 */
	public static Variant newParsedVa(string format, void** app)
	{
	...
	{
		auto __p = g_variant_new_signature(Str.toStringz(signature));
	 ...
	 * Since: 2.24
	 */
	public static Variant newString(string string_)
	{
	 ...
	 * Since: 2.24
	 */
	public static Variant newStrv(string[] strv)
	{
	 ...
	 * Since: 2.38
	 */
	public static Variant newTakeString(string string_)
	{
		auto __p = g_variant_new_take_string(Str.toStringz(string_));
	 ...
	 * Since: 2.24
	 */
	public static Variant newVa(string formatString, string[] endptr, void** app)
	{
