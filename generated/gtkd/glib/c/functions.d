...
shared static this()
{
	...
	Linker.link(g_array_new_take, "g_array_new_take", LIBRARY_GLIB);
	Linker.link(g_array_new_take_zero_terminated, "g_array_new_take_zero_terminated", LIBRARY_GLIB);
	...
	Linker.link(g_bookmark_file_copy, "g_bookmark_file_copy", LIBRARY_GLIB);
	...
	Linker.link(g_hash_table_get_keys_as_ptr_array, "g_hash_table_get_keys_as_ptr_array", LIBRARY_GLIB);
	Linker.link(g_hash_table_get_values, "g_hash_table_get_values", LIBRARY_GLIB);
	Linker.link(g_hash_table_get_values_as_ptr_array, "g_hash_table_get_values_as_ptr_array", LIBRARY_GLIB);
	...
	Linker.link(g_hash_table_steal_all_keys, "g_hash_table_steal_all_keys", LIBRARY_GLIB);
	Linker.link(g_hash_table_steal_all_values, "g_hash_table_steal_all_values", LIBRARY_GLIB);
	...
	Linker.link(g_path_buf_clear, "g_path_buf_clear", LIBRARY_GLIB);
	Linker.link(g_path_buf_clear_to_path, "g_path_buf_clear_to_path", LIBRARY_GLIB);
	Linker.link(g_path_buf_copy, "g_path_buf_copy", LIBRARY_GLIB);
	Linker.link(g_path_buf_free, "g_path_buf_free", LIBRARY_GLIB);
	Linker.link(g_path_buf_free_to_path, "g_path_buf_free_to_path", LIBRARY_GLIB);
	Linker.link(g_path_buf_init, "g_path_buf_init", LIBRARY_GLIB);
	Linker.link(g_path_buf_init_from_path, "g_path_buf_init_from_path", LIBRARY_GLIB);
	Linker.link(g_path_buf_pop, "g_path_buf_pop", LIBRARY_GLIB);
	Linker.link(g_path_buf_push, "g_path_buf_push", LIBRARY_GLIB);
	Linker.link(g_path_buf_set_extension, "g_path_buf_set_extension", LIBRARY_GLIB);
	Linker.link(g_path_buf_set_filename, "g_path_buf_set_filename", LIBRARY_GLIB);
	Linker.link(g_path_buf_to_path, "g_path_buf_to_path", LIBRARY_GLIB);
	Linker.link(g_path_buf_equal, "g_path_buf_equal", LIBRARY_GLIB);
	Linker.link(g_path_buf_new, "g_path_buf_new", LIBRARY_GLIB);
	Linker.link(g_path_buf_new_from_path, "g_path_buf_new_from_path", LIBRARY_GLIB);
	...
	Linker.link(g_ptr_array_is_null_terminated, "g_ptr_array_is_null_terminated", LIBRARY_GLIB);
	Linker.link(g_ptr_array_new, "g_ptr_array_new", LIBRARY_GLIB);
	Linker.link(g_ptr_array_new_from_array, "g_ptr_array_new_from_array", LIBRARY_GLIB);
	Linker.link(g_ptr_array_new_from_null_terminated_array, "g_ptr_array_new_from_null_terminated_array", LIBRARY_GLIB);
	Linker.link(g_ptr_array_new_full, "g_ptr_array_new_full", LIBRARY_GLIB);
	Linker.link(g_ptr_array_new_null_terminated, "g_ptr_array_new_null_terminated", LIBRARY_GLIB);
	Linker.link(g_ptr_array_new_take, "g_ptr_array_new_take", LIBRARY_GLIB);
	Linker.link(g_ptr_array_new_take_null_terminated, "g_ptr_array_new_take_null_terminated", LIBRARY_GLIB);
	...
	Linker.link(g_ptr_array_sort_values, "g_ptr_array_sort_values", LIBRARY_GLIB);
	Linker.link(g_ptr_array_sort_values_with_data, "g_ptr_array_sort_values_with_data", LIBRARY_GLIB);
	...
	Linker.link(g_string_free_and_steal, "g_string_free_and_steal", LIBRARY_GLIB);
...
__gshared extern(C)
{
	...
	GArray* function(void* data, size_t len, int clear, size_t elementSize) c_g_array_new_take;
	GArray* function(void* data, int clear, size_t elementSize) c_g_array_new_take_zero_terminated;
	...
	GPathBuf* function(GPathBuf* buf, char* path) c_g_path_buf_init_from_path;
	int function(GPathBuf* buf) c_g_path_buf_pop;
	GPathBuf* function(GPathBuf* buf, char* path) c_g_path_buf_push;
	int function(GPathBuf* buf, char* extension) c_g_path_buf_set_extension;
	int function(GPathBuf* buf, char* fileName) c_g_path_buf_set_filename;
	char* function(GPathBuf* buf) c_g_path_buf_to_path;
	int function(void* v1, void* v2) c_g_path_buf_equal;
	GPathBuf* function() c_g_path_buf_new;
	GPathBuf* function(char* path) c_g_path_buf_new_from_path;
	...
	int function(GPtrArray* array) c_g_ptr_array_is_null_terminated;
	...
	GPtrArray* function(uint reservedSize, GDestroyNotify elementFreeFunc, int nullTerminated) c_g_ptr_array_new_null_terminated;
...
alias c_g_array_new_take g_array_new_take;
alias c_g_array_new_take_zero_terminated g_array_new_take_zero_terminated;
...
alias c_g_bookmark_file_copy g_bookmark_file_copy;
...
alias c_g_hash_table_get_keys_as_ptr_array g_hash_table_get_keys_as_ptr_array;
alias c_g_hash_table_get_values g_hash_table_get_values;
alias c_g_hash_table_get_values_as_ptr_array g_hash_table_get_values_as_ptr_array;
...
alias c_g_hash_table_steal_all_keys g_hash_table_steal_all_keys;
alias c_g_hash_table_steal_all_values g_hash_table_steal_all_values;
...
alias c_g_path_buf_clear g_path_buf_clear;
alias c_g_path_buf_clear_to_path g_path_buf_clear_to_path;
alias c_g_path_buf_copy g_path_buf_copy;
alias c_g_path_buf_free g_path_buf_free;
alias c_g_path_buf_free_to_path g_path_buf_free_to_path;
alias c_g_path_buf_init g_path_buf_init;
alias c_g_path_buf_init_from_path g_path_buf_init_from_path;
alias c_g_path_buf_pop g_path_buf_pop;
alias c_g_path_buf_push g_path_buf_push;
alias c_g_path_buf_set_extension g_path_buf_set_extension;
alias c_g_path_buf_set_filename g_path_buf_set_filename;
alias c_g_path_buf_to_path g_path_buf_to_path;
alias c_g_path_buf_equal g_path_buf_equal;
alias c_g_path_buf_new g_path_buf_new;
alias c_g_path_buf_new_from_path g_path_buf_new_from_path;
...
alias c_g_ptr_array_is_null_terminated g_ptr_array_is_null_terminated;
alias c_g_ptr_array_new g_ptr_array_new;
alias c_g_ptr_array_new_from_array g_ptr_array_new_from_array;
alias c_g_ptr_array_new_from_null_terminated_array g_ptr_array_new_from_null_terminated_array;
alias c_g_ptr_array_new_full g_ptr_array_new_full;
alias c_g_ptr_array_new_null_terminated g_ptr_array_new_null_terminated;
alias c_g_ptr_array_new_take g_ptr_array_new_take;
alias c_g_ptr_array_new_take_null_terminated g_ptr_array_new_take_null_terminated;
...
alias c_g_ptr_array_sort_values g_ptr_array_sort_values;
alias c_g_ptr_array_sort_values_with_data g_ptr_array_sort_values_with_data;
...
alias c_g_string_free_and_steal g_string_free_and_steal;
