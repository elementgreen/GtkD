...
public class Bytes
{
	 ...
	 * Since: 2.32
	 */
	public static Bytes newStatic(ubyte[] data)
	{
		auto __p = g_bytes_new_static(data.ptr, cast(size_t)data.length);
	 ...
	 * Since: 2.32
	 */
	public static Bytes newTake(ubyte[] data)
	{
		auto __p = g_bytes_new_take(data.ptr, cast(size_t)data.length);
	 ...
	 * Since: 2.32
	 */
	public static Bytes newWithFreeFunc(ubyte[] data, GDestroyNotify freeFunc, void* userData)
	{
