...
public class ArrayG
{
	 ...
	 * Since: 2.76
	 */
	public static ArrayG newTake(void*[] data, bool clear, size_t elementSize)
	{
		...
		return new ArrayG(cast(GArray*) __p, true);
	}
	 ...
	 * Since: 2.76
	 */
	public static ArrayG newTakeZeroTerminated(void*[] data, bool clear, size_t elementSize)
	{
		auto __p = g_array_new_take_zero_terminated(data.ptr, clear, elementSize);
