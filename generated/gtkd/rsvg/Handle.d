...
public class Handle : ObjectG
{
	 ...
	 */
	public static Handle newFromData(ubyte[] data)
	{
		GError* err = null;
		...
		return ObjectG.getDObject!(Handle)(cast(RsvgHandle*) __p, true);
	}
	 ...
	 * Throws: GException on failure.
	 */
	public static Handle newFromGfileSync(FileIF file, RsvgHandleFlags flags, Cancellable cancellable)
	{
		GError* err = null;
	 ...
	 * Throws: GException on failure.
	 */
	public static Handle newFromStreamSync(InputStream inputStream, FileIF baseFile, RsvgHandleFlags flags, Cancellable cancellable)
	{
		GError* err = null;
	 ...
	 * Since: 2.36
	 */
	public static Handle newWithFlags(RsvgHandleFlags flags)
	{
