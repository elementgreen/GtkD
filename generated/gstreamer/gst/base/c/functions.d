...
shared static this()
{
	...
	Linker.link(gst_aggregator_get_force_live, "gst_aggregator_get_force_live", LIBRARY_GSTBASE);
	...
	Linker.link(gst_aggregator_set_force_live, "gst_aggregator_set_force_live", LIBRARY_GSTBASE);
	...
	// gst.base.TypeFindData

	Linker.link(gst_type_find_data_free, "gst_type_find_data_free", LIBRARY_GSTBASE);
	Linker.link(gst_type_find_data_get_caps, "gst_type_find_data_get_caps", LIBRARY_GSTBASE);
	Linker.link(gst_type_find_data_get_probability, "gst_type_find_data_get_probability", LIBRARY_GSTBASE);
	Linker.link(gst_type_find_data_get_typefind, "gst_type_find_data_get_typefind", LIBRARY_GSTBASE);
	Linker.link(gst_type_find_data_new, "gst_type_find_data_new", LIBRARY_GSTBASE);
...
__gshared extern(C)
{
	...
	int function(GstAggregator* self) c_gst_aggregator_get_force_live;
	...
	void function(GstAggregator* self, int forceLive) c_gst_aggregator_set_force_live;
	...
	GstTypeFindData* function(GstObject* obj, ubyte* data, size_t size) c_gst_type_find_data_new;
...
alias c_gst_aggregator_get_force_live gst_aggregator_get_force_live;
...
alias c_gst_aggregator_set_force_live gst_aggregator_set_force_live;
...
alias c_gst_type_find_data_free gst_type_find_data_free;
alias c_gst_type_find_data_get_caps gst_type_find_data_get_caps;
alias c_gst_type_find_data_get_probability gst_type_find_data_get_probability;
alias c_gst_type_find_data_get_typefind gst_type_find_data_get_typefind;
alias c_gst_type_find_data_new gst_type_find_data_new;
