...
public class Structure
{
	 ...
	 * Since: 1.2
	 */
	public static Structure newFromString(string string_)
	{
		auto __p = gst_structure_new_from_string(Str.toStringz(string_));
	 ...
	 * Returns: a new, empty #GstStructure
	 */
	public static Structure newIdEmpty(GQuark quark)
	{
	 ...
	 */
	public static Structure newValist(string name, string firstfield, void* varargs)
	{
	 ...
	 * Since: 1.22
	 */
	public bool getFlags(string fieldname, GType flagsType, out uint value)
	{
		return gst_structure_get_flags(gstStructure, Str.toStringz(fieldname), flagsType, &value) != 0;
	}
