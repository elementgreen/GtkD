...
public class Message
{
	 ...
	 *     MT safe.
	 */
	public static Message newApplication(ObjectGst src, Structure structure)
	{
		auto __p = gst_message_new_application((src is null) ? null : src.getObjectGstStruct(), (structure is null) ? null : structure.getStructureStruct(true));
	...
	{
		auto __p = gst_message_new_async_done((src is null) ? null : src.getObjectGstStruct(), runningTime);
	...
	{
		auto __p = gst_message_new_async_start((src is null) ? null : src.getObjectGstStruct());
	 ...
	 */
	public static Message newBuffering(ObjectGst src, int percent)
	{
		auto __p = gst_message_new_buffering((src is null) ? null : src.getObjectGstStruct(), percent);
	 ...
	 *     MT safe.
	 */
	public static Message newClockLost(ObjectGst src, Clock clock)
	{
		auto __p = gst_message_new_clock_lost((src is null) ? null : src.getObjectGstStruct(), (clock is null) ? null : clock.getClockStruct());
	 ...
	 *     MT safe.
	 */
	public static Message newClockProvide(ObjectGst src, Clock clock, bool ready)
	{
		auto __p = gst_message_new_clock_provide((src is null) ? null : src.getObjectGstStruct(), (clock is null) ? null : clock.getClockStruct(), ready);
	 ...
	 *     MT safe.
	 */
	public static Message newCustom(GstMessageType type, ObjectGst src, Structure structure)
	{
		auto __p = gst_message_new_custom(type, (src is null) ? null : src.getObjectGstStruct(), (structure is null) ? null : structure.getStructureStruct(true));
	...
	{
		auto __p = gst_message_new_device_added((src is null) ? null : src.getObjectGstStruct(), (device is null) ? null : device.getDeviceStruct());
	 ...
	 * Since: 1.16
	 */
	public static Message newDeviceChanged(ObjectGst src, Device device, Device changedDevice)
	{
		auto __p = gst_message_new_device_changed((src is null) ? null : src.getObjectGstStruct(), (device is null) ? null : device.getDeviceStruct(), (changedDevice is null) ? null : changedDevice.getDeviceStruct());
	...
	{
		auto __p = gst_message_new_device_removed((src is null) ? null : src.getObjectGstStruct(), (device is null) ? null : device.getDeviceStruct());
	...
	{
		auto __p = gst_message_new_duration_changed((src is null) ? null : src.getObjectGstStruct());
	...
	{
		auto __p = gst_message_new_element((src is null) ? null : src.getObjectGstStruct(), (structure is null) ? null : structure.getStructureStruct(true));
	...
	{
		auto __p = gst_message_new_eos((src is null) ? null : src.getObjectGstStruct());
	 ...
	 *     MT safe.
	 */
	public static Message newError(ObjectGst src, ErrorG error, string debug_)
	{
		auto __p = gst_message_new_error((src is null) ? null : src.getObjectGstStruct(), (error is null) ? null : error.getErrorGStruct(), Str.toStringz(debug_));
	 ...
	 * Since: 1.10
	 */
	public static Message newErrorWithDetails(ObjectGst src, ErrorG error, string debug_, Structure details)
	{
		auto __p = gst_message_new_error_with_details((src is null) ? null : src.getObjectGstStruct(), (error is null) ? null : error.getErrorGStruct(), Str.toStringz(debug_), (details is null) ? null : details.getStructureStruct(true));
	 ...
	 * Since: 1.2
	 */
	public static Message newHaveContext(ObjectGst src, Context context)
	{
		auto __p = gst_message_new_have_context((src is null) ? null : src.getObjectGstStruct(), (context is null) ? null : context.getContextStruct());
	 ...
	 *     MT safe.
	 */
	public static Message newInfo(ObjectGst src, ErrorG error, string debug_)
	{
		auto __p = gst_message_new_info((src is null) ? null : src.getObjectGstStruct(), (error is null) ? null : error.getErrorGStruct(), Str.toStringz(debug_));
	 ...
	 * Since: 1.10
	 */
	public static Message newInfoWithDetails(ObjectGst src, ErrorG error, string debug_, Structure details)
	{
		auto __p = gst_message_new_info_with_details((src is null) ? null : src.getObjectGstStruct(), (error is null) ? null : error.getErrorGStruct(), Str.toStringz(debug_), (details is null) ? null : details.getStructureStruct(true));
	 ...
	 * Since: 1.18
	 */
	public static Message newInstantRateRequest(ObjectGst src, double rateMultiplier)
	{
		auto __p = gst_message_new_instant_rate_request((src is null) ? null : src.getObjectGstStruct(), rateMultiplier);
	...
	{
		auto __p = gst_message_new_latency((src is null) ? null : src.getObjectGstStruct());
	 ...
	 * Since: 1.2
	 */
	public static Message newNeedContext(ObjectGst src, string contextType)
	{
		auto __p = gst_message_new_need_context((src is null) ? null : src.getObjectGstStruct(), Str.toStringz(contextType));
	...
	{
		auto __p = gst_message_new_new_clock((src is null) ? null : src.getObjectGstStruct(), (clock is null) ? null : clock.getClockStruct());
	 ...
	 */
	public static Message newProgress(ObjectGst src, GstProgressType type, string code, string text)
	{
		auto __p = gst_message_new_progress((src is null) ? null : src.getObjectGstStruct(), type, Str.toStringz(code), Str.toStringz(text));
	 ...
	 * Since: 1.10
	 */
	public static Message newPropertyNotify(ObjectGst src, string propertyName, Value val)
	{
		auto __p = gst_message_new_property_notify((src is null) ? null : src.getObjectGstStruct(), Str.toStringz(propertyName), (val is null) ? null : val.getValueStruct());
	 ...
	 *     MT safe.
	 */
	public static Message newQos(ObjectGst src, bool live, ulong runningTime, ulong streamTime, ulong timestamp, ulong duration)
	{
		auto __p = gst_message_new_qos((src is null) ? null : src.getObjectGstStruct(), live, runningTime, streamTime, timestamp, duration);
	 ...
	 * Since: 1.10
	 */
	public static Message newRedirect(ObjectGst src, string location, TagList tagList, Structure entryStruct)
	{
	 ...
	 *     MT safe.
	 */
	public static Message newRequestState(ObjectGst src, GstState state)
	{
		auto __p = gst_message_new_request_state((src is null) ? null : src.getObjectGstStruct(), state);
	 ...
	 *     MT safe.
	 */
	public static Message newResetTime(ObjectGst src, GstClockTime runningTime)
	{
		auto __p = gst_message_new_reset_time((src is null) ? null : src.getObjectGstStruct(), runningTime);
	...
	{
		auto __p = gst_message_new_segment_done((src is null) ? null : src.getObjectGstStruct(), format, position);
	...
	{
		auto __p = gst_message_new_segment_start((src is null) ? null : src.getObjectGstStruct(), format, position);
	 ...
	 *     MT safe.
	 */
	public static Message newStateChanged(ObjectGst src, GstState oldstate, GstState newstate, GstState pending)
	{
		auto __p = gst_message_new_state_changed((src is null) ? null : src.getObjectGstStruct(), oldstate, newstate, pending);
	...
	{
		auto __p = gst_message_new_state_dirty((src is null) ? null : src.getObjectGstStruct());
	 ...
	 *     MT safe.
	 */
	public static Message newStepDone(ObjectGst src, GstFormat format, ulong amount, double rate, bool flush, bool intermediate, ulong duration, bool eos)
	{
		auto __p = gst_message_new_step_done((src is null) ? null : src.getObjectGstStruct(), format, amount, rate, flush, intermediate, duration, eos);
	 ...
	 *     MT safe.
	 */
	public static Message newStepStart(ObjectGst src, bool active, GstFormat format, ulong amount, double rate, bool flush, bool intermediate)
	{
		auto __p = gst_message_new_step_start((src is null) ? null : src.getObjectGstStruct(), active, format, amount, rate, flush, intermediate);
	...
	{
		auto __p = gst_message_new_stream_collection((src is null) ? null : src.getObjectGstStruct(), (collection is null) ? null : collection.getStreamCollectionStruct());
	 ...
	 *     MT safe.
	 */
	public static Message newStreamStart(ObjectGst src)
	{
	 ...
	 *     MT safe.
	 */
	public static Message newStreamStatus(ObjectGst src, GstStreamStatusType type, Element owner)
	{
		auto __p = gst_message_new_stream_status((src is null) ? null : src.getObjectGstStruct(), type, (owner is null) ? null : owner.getElementStruct());
	...
	{
		auto __p = gst_message_new_streams_selected((src is null) ? null : src.getObjectGstStruct(), (collection is null) ? null : collection.getStreamCollectionStruct());
	 ...
	 *     MT safe.
	 */
	public static Message newStructureChange(ObjectGst src, GstStructureChangeType type, Element owner, bool busy)
	{
		auto __p = gst_message_new_structure_change((src is null) ? null : src.getObjectGstStruct(), type, (owner is null) ? null : owner.getElementStruct(), busy);
	 ...
	 *     MT safe.
	 */
	public static Message newTag(ObjectGst src, TagList tagList)
	{
	 ...
	 *     MT safe.
	 */
	public static Message newToc(ObjectGst src, Toc toc, bool updated)
	{
		auto __p = gst_message_new_toc((src is null) ? null : src.getObjectGstStruct(), (toc is null) ? null : toc.getTocStruct(), updated);
	 ...
	 *     MT safe.
	 */
	public static Message newWarning(ObjectGst src, ErrorG error, string debug_)
	{
		auto __p = gst_message_new_warning((src is null) ? null : src.getObjectGstStruct(), (error is null) ? null : error.getErrorGStruct(), Str.toStringz(debug_));
	 ...
	 * Since: 1.10
	 */
	public static Message newWarningWithDetails(ObjectGst src, ErrorG error, string debug_, Structure details)
	{
		auto __p = gst_message_new_warning_with_details((src is null) ? null : src.getObjectGstStruct(), (error is null) ? null : error.getErrorGStruct(), Str.toStringz(debug_), (details is null) ? null : details.getStructureStruct(true));
	...
	public Message copy()
	{
		auto __p = gst_message_copy(gstMessage);
	...
	{
		auto __p = gst_message_get_stream_status_object(gstMessage);
	...
	{
		auto __p = gst_message_get_structure(gstMessage);
	...
	public bool parseContextType(out string contextType)
	{
		...
		auto __p = gst_message_parse_context_type(gstMessage, &outcontextType) != 0;
	...
	{
		gst_message_parse_instant_rate_request(gstMessage, &rateMultiplier);
	}
	...
	{
		auto __p = gst_message_streams_selected_get_stream(gstMessage, idx);
	...
	{
		auto __p = gst_message_writable_structure(gstMessage);
	 ...
	 */
	public static bool replace(ref Message oldMessage, Message newMessage)
	{
		GstMessage* outoldMessage = oldMessage.getMessageStruct();

		auto __p = gst_message_replace(&outoldMessage, (newMessage is null) ? null : newMessage.getMessageStruct()) != 0;
