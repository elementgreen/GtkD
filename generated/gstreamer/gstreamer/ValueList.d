...
public class ValueList
{
	...
	{
		GValue* outdest = cast(GValue*)Memory.malloc0(GValue.sizeof);
	...
	{
		auto __p = gst_value_list_get_value((value is null) ? null : value.getValueStruct(), index);
	...
	{
		auto __p = gst_value_list_init((value is null) ? null : value.getValueStruct(), prealloc);
