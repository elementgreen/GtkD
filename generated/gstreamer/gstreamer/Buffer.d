...
public class Buffer
{
	 ...
	 */
	public static Buffer newAllocate(Allocator allocator, size_t size, AllocationParams params)
	{
	 ...
	 * Since: 1.20
	 */
	public static Buffer newMemdup(ubyte[] data)
	{
		auto __p = gst_buffer_new_memdup(data.ptr, cast(size_t)data.length);
	 ...
	 * Returns: a new #GstBuffer
	 */
	public static Buffer newWrapped(ubyte[] data)
	{
	 ...
	 * Returns: a new #GstBuffer
	 */
	public static Buffer newWrappedFull(GstMemoryFlags flags, ubyte[] data, size_t maxsize, size_t offset, void* userData, GDestroyNotify notify)
	{
