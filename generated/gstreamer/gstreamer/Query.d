...
public class Query
{
	...
	{
		auto __p = gst_query_new_accept_caps((caps is null) ? null : caps.getCapsStruct());
	 ...
	 * Returns: a new #GstQuery
	 */
	public static Query newBuffering(GstFormat format)
	{
	 ...
	 * Returns: a #GstQuery
	 */
	public static Query newConvert(GstFormat srcFormat, long value, GstFormat destFormat)
	{
	 ...
	 * Returns: a new #GstQuery
	 */
	public static Query newCustom(GstQueryType type, Structure structure)
	{
	...
	{
		auto __p = gst_query_new_duration(format);
	...
	{
		auto __p = gst_query_new_formats();
	...
	{
		auto __p = gst_query_new_latency();
	...
	{
		auto __p = gst_query_new_position(format);
	...
	{
		auto __p = gst_query_new_scheduling();
	...
	{
		auto __p = gst_query_new_seeking(format);
	...
	{
		auto __p = gst_query_new_segment(format);
	...
	{
		auto __p = gst_query_new_selectable();
	...
	public void parseNthAllocationParam(uint index, out Allocator allocator, out AllocationParams params)
	{
		...
		GstAllocationParams* outparams = cast(GstAllocationParams*)Memory.malloc0(GstAllocationParams.sizeof);
	...
	public void parseSelectable(out bool selectable)
	{
		...
		gst_query_parse_selectable(gstQuery, &outselectable);

		selectable = (outselectable == 1);
	}
	...
	{
		gst_query_set_selectable(gstQuery, selectable);
	}
