...
public template ChildProxyT(TStruct)
{
	 ...
	 * Since: 1.22
	 */
	public ObjectG getChildByNameRecurse(string name)
	{
		auto __p = gst_child_proxy_get_child_by_name_recurse(getChildProxyStruct(), Str.toStringz(name));
	...
	{
		GValue* outvalue = cast(GValue*)Memory.malloc0(GValue.sizeof);
