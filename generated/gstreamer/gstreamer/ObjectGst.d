...
public class ObjectGst : ObjectG
{
	 ...
	 * Returns: %TRUE if the given array could be filled, %FALSE otherwise
	 */
	public bool getValueArray(string propertyName, GstClockTime timestamp, GstClockTime interval, void*[] values)
	{
		return gst_object_get_value_array(gstObject, Str.toStringz(propertyName), timestamp, interval, cast(uint)values.length, values.ptr) != 0;
	}
