...
public class Event
{
	 ...
	 */
	public static Event newBufferSize(GstFormat format, long minsize, long maxsize, bool async)
	{
	 ...
	 */
	public static Event newCustom(GstEventType type, Structure structure)
	{
	...
	{
		auto __p = gst_event_new_flush_start();
	 ...
	 */
	public static Event newGap(GstClockTime timestamp, GstClockTime duration)
	{
	 ...
	 * Since: 1.18
	 */
	public static Event newInstantRateChange(double rateMultiplier, GstSegmentFlags newFlags)
	{
	 ...
	 * Since: 1.18
	 */
	public static Event newInstantRateSyncTime(double rateMultiplier, GstClockTime runningTime, GstClockTime upstreamRunningTime)
	{
	 ...
	 * Returns: a new #GstEvent
	 */
	public static Event newLatency(GstClockTime latency)
	{
	 ...
	 */
	public static Event newQos(GstQOSType type, double proportion, GstClockTimeDiff diff, GstClockTime timestamp)
	{
	 ...
	 */
	public static Event newSeek(double rate, GstFormat format, GstSeekFlags flags, GstSeekType startType, long start, GstSeekType stopType, long stop)
	{
	 ...
	 * Returns: a new #GstEvent
	 */
	public static Event newSegmentDone(GstFormat format, long position)
	{
	 ...
	 * Since: 1.10
	 */
	public static Event newSelectStreams(ListG streams)
	{
	 ...
	 * Returns: a new #GstEvent
	 */
	public static Event newStep(GstFormat format, ulong amount, double rate, bool flush, bool intermediate)
	{
	...
	{
		auto __p = gst_event_new_toc_select(Str.toStringz(uid));
